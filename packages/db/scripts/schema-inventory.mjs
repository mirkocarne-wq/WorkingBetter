...
const modules = [
  ['Core', ['tenants', 'org_units', 'persons', 'users', 'person_history', 'role_assignments', 'naming_overrides', 'person_field_defs', 'role_definitions', 'audit_log']],
  ...
  ['App Studio (APP)', ['apps', 'app_instances', 'app_stage_runs', 'app_instance_events', 'webhook_deliveries', 'automation_rules', 'automation_runs']],
];
