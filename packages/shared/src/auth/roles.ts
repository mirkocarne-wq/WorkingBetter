...
const P = Permissions;
const employee: Permission[] = [P.PEOPLE_READ, P.ORG_READ, P.OBJECTIVES_READ, P.OBJECTIVES_WRITE_OWN, P.ONE_ON_ONES_PARTICIPATE, P.FEEDBACK_GIVE, P.NOTIFICATIONS_READ, P.FORMS_RESPOND, P.REVIEWS_PARTICIPATE, P.SURVEYS_RESPOND];
...
const hrAdmin: Permission[] = [...hrbp, P.CYCLES_WRITE, P.OBJECTIVES_WRITE_COMPANY, P.ROLES_MANAGE, P.AUDIT_READ, P.FEEDBACK_MODERATE, P.VALUES_MANAGE, P.FORMS_MANAGE, P.SURVEYS_MANAGE];
