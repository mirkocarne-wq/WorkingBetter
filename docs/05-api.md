...
| Review | `/review-cycles`, `/reviews` (dettaglio, contesto, condivisione, firma, riapertura, `/{id}/pdf`), `/calibration-sessions` | Specializzazione; dal sprint 16 ogni review è un'istanza del motore (`appInstanceId`) |
