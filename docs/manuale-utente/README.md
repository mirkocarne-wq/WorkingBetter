...
Questo manuale spiega **come si usa WorkingBetter, schermata per schermata**, per ciascun ruolo: collaboratore, manager, HR e amministratore. Ogni sezione mostra la schermata reale, dice cosa contiene e come si fa ogni operazione, passo per passo. Le schermate provengono dall'azienda dimostrativa «Acme S.p.A.» inclusa nel prodotto.
...
| amministratore del tenant | [4 · HR](04-hr.md) e [5 · Amministratore](05-amministratore.md) | 30 minuti |

Ogni ruolo include quello precedente: un manager fa tutto ciò che fa un collaboratore, HR tutto ciò che fa un manager, e così via. Le funzioni in più compaiono nel menu di sinistra solo se il tuo ruolo le prevede.
...
4. [HR](04-hr.md)
5. [Amministratore](05-amministratore.md)
6. [Riferimenti rapidi](06-riferimenti.md): stati, scadenze, glossario
