...
![Pagina di accesso con email e password](img/00-login.jpg)
...
![Recupero password](img/00-forgot.jpg)
...
- **Home**: saluto, la frase che riassume cosa hai in sospeso, quattro indicatori (obiettivi attivi con anello di progresso, a rischio, check-in in ritardo, prossimo 1:1 oppure riporti diretti se hai un team), l'elenco **Da fare**, i tuoi obiettivi e, se hai un team, la tabella del team. A destra **Salute**: la barra a segmenti con lo stato dei tuoi obiettivi (on track, a rischio, off track, senza check-in), il progresso medio e i risultati chiave entro la cadenza; poi la scheda del **prossimo 1:1** con l'agenda e, finché non hai finito l'avviamento, i **Primi passi** con **Apri la guida** e **Nascondi**.
...
![Guida del collaboratore: passi con stato e istruzioni](img/emp-guida.jpg)
...
![Notifiche in arrivo](img/emp-notifiche.jpg)

![Preferenze delle notifiche per tipo e canale](img/emp-notifiche-preferenze.jpg)
...
![Impostazioni personali: verifica in due passaggi, password, integrazioni, calendario](img/emp-impostazioni.jpg)
