...
- [ ] Immagini costruite dal `Dockerfile` (target `api`, `workers`, `web`) con `NEXT_PUBLIC_API_URL` dell'API pubblica; `API_PUBLIC_URL`, `APP_BASE_URL`, `API_CORS_ORIGIN` coerenti con i domini.
