...
12. **Persone → Importa da CSV** (Chiara, HR): scarica il template, incolla righe, guarda l'anteprima con gli errori, conferma.
13. **Worker**: i promemoria girano ogni 15 minuti (configurabile). Per forzarli subito:
