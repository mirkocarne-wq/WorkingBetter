...
10. **Persone → Importa da CSV** (Chiara, HR): scarica il template, incolla righe, guarda l'anteprima con gli errori, conferma.
11. **Worker**: i promemoria girano ogni 15 minuti (configurabile). Per forzarli subito:
